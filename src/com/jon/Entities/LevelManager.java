...
public class LevelManager {
	...
	public Level getCurrentLevel(){
		...
		if(getLevel(1).getNumEnemyKilled() != 40 || !(getLevel(1).isBossDead()) || flag4){
			if((getLevel(1).getNumEnemyKilled() == 40) && flag1){
		...
		if(getLevel(2).getNumEnemyKilled() != 50 || !(getLevel(2).isBossDead()) || flag5){
		
				if(getLevel(2).getNumEnemyKilled() == 50 && flag2){
		...
		if(getLevel(3).getNumEnemyKilled() != 60 || !(getLevel(3).isBossDead()) || flag6){
			System.out.println("ENTERED LEVEL 3");
					if(getLevel(3).getNumEnemyKilled() == 60 && flag3){
