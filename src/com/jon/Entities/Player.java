...
public class Player extends GameObject implements EntityA{
	...
	{	
		...
		try 
		{
			imageFront = ImageIO.read(new File("res\\images\\snowPic.png"));
			
			imageLife = ImageIO.read(new File("res\\\\images\\heart.png"));
			
			imageLeft1 = ImageIO.read(new File("res\\images\\RyukLeft1.png"));
			imageLeft2 = ImageIO.read(new File("res\\images\\RyukLeft2.png"));
			
			imageRight1 = ImageIO.read(new File("res\\images\\RyukRight1.png"));
			imageRight2 = ImageIO.read(new File("res\\images\\RyukRight2.png"));
